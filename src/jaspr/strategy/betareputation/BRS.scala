...
import jaspr.bootstrapsim.strategy.{BRSInit, BRSCore}
...
/**
  ...
  */
class BRS(override val witnessWeight: Double = 2d) extends CompositionStrategy with Exploration with BRSCore {
