% Effect of number of reported observations on perfect reputation source
%
% Usage: simData  = exp22a
%
function [errData timeData conditions]  = exp22a(expName)
...
noRepObs = unique(floor(exp([0:0.25:5.5])));
...
for i=1:numel(sources)
   ...
   sources{i} = disNoiseFunch(mainf,multinomial(sample(dirichlet(5))),0.5);
