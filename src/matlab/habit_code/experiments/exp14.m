% Script for testing how number of trustees observations impacts on
% group behaviour performance.
% More general sets of group
%
% Usage: simData  = exp14
%
function [errData timeData conditions]  = exp14(expName)
...
noSeedObs = unique(floor(exp([2:1:5.5])));
noRepObs = 0;
noTestRepObs = 0;
