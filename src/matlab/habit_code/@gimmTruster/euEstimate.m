...
if resultFlag
   ...
   %***************************************************************************
   %   Calculate estimate using best linear unbiased estimate (BLUE).
   %   Ok, BLUE is frequentist terminology, but in practice does what its
   %   suppose to without too much effort.
   %***************************************************************************
